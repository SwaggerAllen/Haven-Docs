...
2. [We built the internet as if every man were an island](docs/outreach/intro-article-2-island.md)
3. [The five open problems](docs/outreach/intro-article-3-stuck.md)

**The Slow Play:**

4. [The competitive ground](docs/outreach/intro-article-4-timescale.md)
5. [Design-first methodology](docs/outreach/intro-article-5-methodology.md)
6. [Founder succession](docs/outreach/intro-article-6-survival.md)
